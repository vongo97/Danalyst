    ...
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-7xl font-extrabold mb-6 leading-tight">
              Domina el <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-pink-300">Análisis de Datos</span> y Transforma tu Futuro
            </h1>
            <p className="text-xl md:text-2xl mb-10 text-indigo-100">
              ...
              Impulsa tu carrera y alcanza tus metas profesionales.
            </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {stats.map((stat, index) => (
              <div key={index} className="transform transition-all hover:scale-105">
                <p className="text-4xl md:text-5xl font-bold text-indigo-600">{stat.number}</p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Todo lo que necesitas para dominar el análisis de datos</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Nuestra plataforma ofrece herramientas y recursos completos para impulsar tu carrera en el análisis de datos.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 transform transition-all hover:shadow-xl hover:-translate-y-1">
              ...
              <p className="text-gray-600 mb-6">
                Explora nuestra amplia variedad de cursos diseñados para todos los niveles, desde principiantes hasta expertos en análisis de datos.
              </p>
              <Link
                href="/courses"
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 transform transition-all hover:shadow-xl hover:-translate-y-1">
              ...
              <h3 className="text-2xl font-bold mb-3">Generador de Plantillas</h3>
              <p className="text-gray-600 mb-6">
                Crea plantillas de análisis personalizadas con ayuda de IA. Ahorra tiempo y mejora la calidad de tus informes y presentaciones.
              </p>
              <Link
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 transform transition-all hover:shadow-xl hover:-translate-y-1">
              ...
              <p className="text-gray-600 mb-6">
                Accede a contenido exclusivo, mentorías personalizadas, networking y herramientas avanzadas para acelerar tu crecimiento profesional.
              </p>
              <Link
                href="/membership"
                className="inline-flex items-center text-indigo-600 hover:text-indigo-800 font-medium"
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Descubre cómo nuestra plataforma ha ayudado a profesionales a alcanzar sus metas en el campo del análisis de datos.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="bg-gray-50 rounded-xl p-8 shadow-lg relative">
      ...
      <section className="py-20 bg-gradient-to-r from-indigo-600 to-purple-700 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-5xl font-bold mb-6">¿Listo para comenzar tu viaje?</h2>
          <p className="text-xl mb-10 max-w-3xl mx-auto text-indigo-100">
            Únete a miles de profesionales que están transformando sus carreras con nuestros cursos y herramientas de análisis de datos.
          </p>
          <Link
            href="/courses"
