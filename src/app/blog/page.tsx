...
import { getAllBlogPosts, BlogPost } from './lib/posts';
            ...
            <section className="relative py-24 bg-gradient-to-r from-indigo-600 to-purple-700 text-white overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10 text-center">
                    <h1 className="text-4xl md:text-6xl font-bold mb-6">
                        Blog de <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-200 to-indigo-100">{siteConfig.name}</span>
                    </h1>
                    <p className="text-xl md:text-2xl max-w-3xl mx-auto text-indigo-100">
                        Artículos, tutoriales y reflexiones sobre el mundo del análisis de datos.
                    </p>
                </div>
            </section>
            ...
            <main className="container mx-auto py-16 px-4 flex-grow">
                ...
                <h2 className="text-3xl font-bold mb-8 text-gray-800">
                    {selectedCategory === 'all' 
                        ? 'Todos los artículos' 
                        : `Artículos de ${
                            selectedCategory === 'python' ? 'Python' : 
                            selectedCategory === 'sql' ? 'SQL' : 
                            selectedCategory === 'visualization' ? 'Visualización' : 
                            'Análisis de Datos'
                          }`
                    }
                </h2>
                ...
                {filteredPosts.length === 0 ? (
                    <div className="text-center py-12">
                        <p className="text-gray-600 text-lg">No hay artículos disponibles en esta categoría.</p>
                    </div>
                ) : (
                ...
                <div className="mt-20 bg-gradient-to-r from-indigo-100 to-purple-100 rounded-2xl p-8 md:p-12">
                    <div className="md:flex items-center justify-between">
                        <div className="mb-6 md:mb-0 md:mr-8">
                            <h3 className="text-2xl font-bold text-gray-900 mb-2">¿Te gusta nuestro contenido?</h3>
                            <p className="text-gray-700">
                                Suscríbete a nuestra membresía para acceder a contenido exclusivo y recursos premium.
                            </p>
                        </div>
