...
export default async function BlogPostPage({ params }: BlogPostPageProps) {
    ...
    // Determinar la imagen de cabecera (usar thumbnailUrl o imageUrl si existe)
    const headerImage = post.imageUrl || post.thumbnailUrl;
                    ...
                    <article className="p-8 md:p-12">
                        ...
                        <div className="prose prose-lg lg:prose-xl max-w-none prose-headings:text-indigo-900 prose-a:text-indigo-600 prose-a:no-underline hover:prose-a:underline prose-img:rounded-lg prose-pre:bg-gray-50 prose-pre:border prose-pre:border-gray-200">
                            {post.contentHtml ? (
                                ...
                                <p>Error: Contenido HTML no generado.</p>
                            )}
                        </div>
                        ...
                        <div className="mt-12 pt-8 border-t border-gray-200">
                            <div className="flex items-center">
                                ...
                                <div className="ml-4">
                                    <p className="font-medium">{siteConfig.creator}</p>
