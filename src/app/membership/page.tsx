...
export const metadata = {
  title: `Membresía Premium | ${siteConfig.name}`,
  description: `Únete a la membresía premium de ${siteConfig.name} y transforma tu carrera en análisis de datos.`,
}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {plans.map((plan, index) => (
              <div 
                key={index} 
                className={`rounded-2xl shadow-xl overflow-hidden transform transition-all ${
                  plan.popular ? 'md:-translate-y-4 scale-105 z-10' : 'hover:scale-105'
                } ${plan.bgColor}`}
              >
                {plan.popular && (
