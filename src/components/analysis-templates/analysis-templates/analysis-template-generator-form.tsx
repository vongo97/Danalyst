    ...
    const renderMarkdown = (text: string) => {
        try {
            ...
            marked.setOptions({
                ...
                mangle: false // No modificar los enlaces de correo electrónico
            });
        ...
        <div>
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                    ...
                    className={`w-full py-3 px-4 bg-indigo-600 text-white rounded-md font-medium transition-colors ${isLoading || !purpose ? 'opacity-70 cursor-not-allowed' : 'hover:bg-indigo-700'
                        }`}
                >
                    {isLoading ? (
